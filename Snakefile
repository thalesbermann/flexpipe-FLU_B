...
rule colours:
	...
	params:
		host = "host",
		lineage = "lineage_truncated lineage",
...
rule traits:
	...
	input:
		...
		metadata = rules.process_metadata.output.final_metadata,
	params:
		columns = "country lineage host_type source"
	output:
